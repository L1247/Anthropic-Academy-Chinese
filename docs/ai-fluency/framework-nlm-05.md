...
**第一章：從理論到實踐——課程設計的核心轉變**

本課是委派能力的「實戰場」。前幾課建立了委派的理論框架，第 05 課的目的是讓你選定一個真實的個人專案，在實際操作中深化對委派的理解。影片強調：委派不是在課堂練習題上做選擇，而是在你真正想完成的目標中做判斷。

**第二章：選對專案——委派練習的基礎**

影片建議選擇「規模夠大（需要多種任務類型）、時間可控（約一小時可完成）、主題真實有感」的專案。四大專案類型供選擇：  
研究型（比較分析多種選項並提出建議）；  
溝通型（撰寫解釋複雜議題的系列文章）；  
創意型（開發特定產品或服務的概念）；  
學習型（為你想掌握的主題創建學習素材）。

**第三章：三步驟委派流程——與 AI 共同規劃**

影片介紹「專案委派」的三個核心步驟：  
**Step 1 選定專案**——確認你真正想完成的事，不是「練習用」的虛假任務；  
**Step 2 願景對齊**——與 AI 討論，直到你對專案的「成功定義」和「最終成果」有清晰藍圖（預計 20 分鐘）；  
**Step 3 委派分析**——逐一拆解任務，判斷哪些部分能有效利用 AI 的能力。

**第四章：委派對話的關鍵態度——雙向而非單向**

影片特別強調：委派分析不是「對 AI 下指令」，而是「與 AI 進行真誠的雙向對話」——挑戰假設、尋求澄清、對意料之外的洞察保持開放。單向陳述無法帶出最深層的委派智慧。

**第五章：儲存計畫——銜接未來的學習**

完成後的委派計畫需要儲存，因為它將成為後續課程（描述、辨識、盡責）的實踐基礎。這份計畫不是一次性作業，而是串起整個 4D 學習旅程的「活文件」。

**影片結語金句**：
> 「最好的委派，來自對你的目標有清晰認識，並願意讓 AI 成為真正的思考夥伴，而非只是執行者。」
