...
- **建立真實評量**：設計需要個人觀點、在地脈絡或即時判斷的評量，使 AI 難以直接代勞
  ...
  真實評量（Authentic Assessment）的核心是讓學生展現**AI 無法替代的能力**。具體策略：要求學生引用自己的親身經歷或在地觀察（AI 無法編造這些）；加入口頭報告或即場問答環節；設計需要批判性評估 AI 輸出的作業（例如「用 AI 生成一份分析，然後寫出你認為 AI 說錯了什麼、為什麼」）；讓學生提交完整的思考過程而不只是最終成品。
