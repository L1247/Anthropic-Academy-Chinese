...
```mermaid
flowchart TD
  A["考慮導入 AI 應用"] --> Q1{"能服務更多<br/>受益者嗎？"}
  Q1 -->|"否"| STOP["⛔ 暫緩導入"]
  Q1 -->|"是"| Q2{"員工能把時間<br/>轉移到使命工作？"}
  Q2 -->|"否"| STOP
  Q2 -->|"是"| Q3{"對受益者<br/>有任何風險？"}
  Q3 -->|"是"| R["先建立風險<br/>管理與監督機制"]
  Q3 -->|"否"| GO["✅ 值得投入"]
  R --> GO
```
...
```mermaid
flowchart TD
  P1["1️⃣ 降低行政負擔<br/>文件、郵件、報告<br/>🟢 低風險 · 高回報"] --> P2
  P2["2️⃣ 放大溝通影響力<br/>募款文案、年度報告<br/>🟡 中等風險"] --> P3
  P3["3️⃣ 數據洞察<br/>受益者分析、成效評估<br/>🟠 中高風險"] --> P4
  P4["4️⃣ 受益者服務<br/>直接接觸受益者<br/>🔴 需最謹慎監督"]
```
