...
const nlm12Slides = [
  { src: '/images/ai-fluency/nlm12-slide-01-title.png', caption: '投影片 01' },
  { src: '/images/ai-fluency/nlm12-slide-02-overview.png', caption: '投影片 02' },
  { src: '/images/ai-fluency/nlm12-slide-03-components.png', caption: '投影片 03' },
  { src: '/images/ai-fluency/nlm12-slide-04-framework.png', caption: '投影片 04' },
  { src: '/images/ai-fluency/nlm12-slide-05-dimensions.png', caption: '投影片 05' },
  { src: '/images/ai-fluency/nlm12-slide-06-assessment.png', caption: '投影片 06' },
  { src: '/images/ai-fluency/nlm12-slide-07-evaluation.png', caption: '投影片 07' },
  { src: '/images/ai-fluency/nlm12-slide-08-guidelines.png', caption: '投影片 08' },
  { src: '/images/ai-fluency/nlm12-slide-09-examples.png', caption: '投影片 09' },
  { src: '/images/ai-fluency/nlm12-slide-10-implementation.png', caption: '投影片 10' },
]
</script>
...
**第一章：自我評估——掌握你目前的 4D 起點**

影片開場引導你進行「目前能力評估」：針對委派、描述、辨識、盡責四個能力，按照三個等級（新手 Novice、發展中 Developing、有信心 Confident）為自己打分。這不是考試，而是找到你最需要加強的那個 D，制定有針對性的成長計畫。

**第二章：建立個人提示詞庫——從一次性到可複用**

影片建議：找出你日常工作中 5 到 10 個常規任務，為每一個開發「模板提示詞（Template Prompt）」，確保每次使用都能穩定產出高品質結果。這個提示詞庫是你的個人 AI 流暢度資產，隨著使用經驗不斷精煉。

**第三章：三個延伸活動——在「玩」中磨礪描述與辨識**

影片介紹三種練習辨識與描述能力的遊戲：  
**交換謎題**——AI 猜你選定的謎題，你透過引導它的思維鏈（而非直接給答案）練習引導技巧；  
**合作填字遊戲**——透過字數、首字母等具體限制練習精確引導 AI 思考；  
**概念與約束**——選取複雜概念加上嚴格限制條件（如「只用烹飪隱喻解釋」），練習在約束中精確描述。  
謎題之所以是絕佳練習工具，是因為它有特定指令和明確的評估標準，非常適合檢驗清晰溝通與過程辨識的能力。

**第四章：建立個人 AI 流暢度計畫——與 Claude 一起規劃**

影片建議：把 Claude 當成「思考夥伴（Thinking Partner）」，分享你的自我評估結果，請它協助設計個人化的成長計畫，並給予反饋。計畫應由你主導，Claude 輔助——不是讓 AI 替你制定，而是與 AI 共同思考。

**第五章：流暢度是旅程，而非終點**

影片以鼓勵作結：AI 流暢度不是一次就能達到的狀態，而是透過持續的委派、描述、辨識與盡責實踐，不斷螺旋式成長的能力。每一次真實的 AI 協作，都是提升流暢度的機會。

**影片結語金句**：
> 「透過實踐、練習並持續應用所學，你將逐漸成為能夠駕馭 AI 的協作者，而非被 AI 工具左右的使用者。」
