      ...
      '/ai-fluency/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: '└ 📓 第 03 課：什麼是生成式 AI？', link: '/ai-fluency/framework-nlm-03' },
            { text: '└ 📓 第 04 課：委派（Delegation）', link: '/ai-fluency/framework-nlm-04' },
            { text: '└ 📓 第 05 課：委派的應用', link: '/ai-fluency/framework-nlm-05' },
            { text: '└ 📓 第 06 課：描述（Description）', link: '/ai-fluency/framework-nlm-06' },
            { text: '└ 📓 第 07 課：有效提示技巧', link: '/ai-fluency/framework-nlm-07' },
            { text: '└ 📓 第 08 課：辨識（Discernment）', link: '/ai-fluency/framework-nlm-08' },
            { text: '└ 📓 第 09 課：描述—辨識循環', link: '/ai-fluency/framework-nlm-09' },
            { text: '└ 📓 第 10 課：盡責（Diligence）', link: '/ai-fluency/framework-nlm-10' },
            { text: '└ 📓 第 11 課：課程總結', link: '/ai-fluency/framework-nlm-11' },
            { text: '└ 📓 第 12 課：延伸活動', link: '/ai-fluency/framework-nlm-12' },
