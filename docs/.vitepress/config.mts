      ...
      '/ai-fluency/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: '└ 📓 第 06 課：AI 能力診斷與限制', link: '/ai-fluency/framework-nlm-06' },
            { text: '└ 📓 第 07 課：深度探討二：AI 與人類合作的未來', link: '/ai-fluency/framework-nlm-07' },
            { text: '└ 📓 第 08 課：實踐工作場景 1：內容創作', link: '/ai-fluency/framework-nlm-08' },
            { text: '└ 📓 第 09 課：實踐工作場景 2：分析與決策', link: '/ai-fluency/framework-nlm-09' },
            { text: '└ 📓 第 10 課：實踐工作場景 3：編碼與技術開發', link: '/ai-fluency/framework-nlm-10' },
            { text: '└ 📓 第 11 課：實踐工作場景 4：學習與個人成長', link: '/ai-fluency/framework-nlm-11' },
            { text: '└ 📓 第 12 課：實踐工作場景 5：策劃與執行', link: '/ai-fluency/framework-nlm-12' },
